...
void TermNode::GenerateIR(IRCtx& ctx) {
}

void ExpressionNode::GenerateIR(IRCtx& ctx) {
}
...
void StatSequenceNode::GenerateIR(IRCtx& ctx) {
}
...
void TypeDeclNode::GenerateIR(IRCtx& ctx) {
}

void VarDeclNode::GenerateIR(IRCtx& ctx) {
}

void FormalParamNode::GenerateIR(IRCtx& ctx) {
}

void FunctionBodyNode::GenerateIR(IRCtx& ctx) {
}
